  ...
  return (
    ...
    <div className="container-fluid mb-5">
        <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            ...
            <button className="navbar-toggler" type="button" data-bs-toggle="navbarNa" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
